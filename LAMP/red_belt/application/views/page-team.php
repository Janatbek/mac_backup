			...
			<div class="breadcrumb-container">
				<div class="container">
					<ol class="breadcrumb">
						...
						<li class="active">Team Options 1</li>
					</ol>
				</div>
			</div>
			<!-- breadcrumb end -->
					...
					<div class="row">
						...
						<div class="main col-md-12">
							...
							<div class="row grid-space-10">
								<div class="col-sm-4">
									<div class="image-box team-member style-2 shadow bordered light-gray-bg text-center">
								...
								<div class="col-sm-4">
									<div class="image-box team-member style-2 shadow bordered light-gray-bg text-center">
										<div class="overlay-container overlay-visible">
											...
											<div class="overlay-bottom">
												<p class="small margin-clear">Ipsum dolor sit amet, consectetur adipisicing elit. Voluptates praesentium nulla cupiditate explicabo ad!</p>
											</div>
										</div>
										<div class="body">
								...
								<div class="col-sm-4">
									<div class="image-box team-member style-2 shadow bordered light-gray-bg text-center">
										<div class="overlay-container overlay-visible">
											...
											<div class="overlay-bottom">
												<p class="small margin-clear">Dolor sit amet, consectetur adipisicing elit. Voluptates praesentium nulla cupiditate molestias vero explicabo!</p>
											</div>
										</div>
										<div class="body">
							...
							<div class="row grid-space-10">
								<div class="col-sm-6 col-md-3">
									<div class="team-member image-box style-2 mb-20 dark-bg text-center">
										...
										<div class="body">
											...
											<div class="separator mt-10"></div>
											<p class="small margin-clear">Lorem ipsum dolor sit amet, consectetur adipisicing elit!</p>
											<a href="mailto:info@theproject.com" class="btn btn-lg-link link-light"><i class="pr-10 fa fa-envelope-o"></i>Contact Me</a>
										</div>
									</div>
								</div>
								<div class="col-sm-6 col-md-3">
								...
								<div class="col-sm-6 col-md-3">
									<div class="team-member image-box style-2 mb-20 dark-bg text-center">
										...
										<div class="body">
											<h3 class="margin-clear">Michael Abudia</h3>
								...
								<div class="col-sm-4">
									<div class="team-member image-box style-2 dark-bg text-center">
										...
										<div class="body">
											...
											<div class="separator mt-10 mb-10"></div>
											<a href="tel:123123123123123" class="margin-clear btn btn-md-link link-light"><i class="pr-10 fa fa-phone"></i>Call</a>
											<a href="mailto:info@theproject.com" class="margin-clear btn btn-md-link link-light"><i class="pr-10 fa fa-envelope-o"></i>Contact</a>
										</div>
									</div>
								</div>
								<div class="col-sm-4">
