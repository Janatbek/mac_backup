...
<head>
	...
	<!-- Has to change for SEO of business -->
							...
							<div class="row grid-space-0">
								<div class="col-md-6">
									<div class="owl-carousel content-slider-with-controls">
										<div class="overlay-container overlay-visible">
											<img src="../../assets/imagesfrom/PTPC_therapeutic-exercises.jpg" alt="">
											<div class="overlay-bottom hidden-xs">
												<div class="text">
													<h3 class="title">We Can Do It</h3>
												</div>
											</div>
											<a href="../../assets/imagesfrom/PTPC_therapeutic-exercises.jpg" class="popup-img overlay-link" title="image title"><i class="icon-plus-1"></i></a>
										</div>
										<div class="overlay-container overlay-visible">
											<img src="../../assets/imagesfrom/PTPC_therapeutic-exercises_1.jpg" alt="">
											<div class="overlay-bottom hidden-xs">
												<div class="text">
													<h3 class="title">You Can Trust Us</h3>
												</div>
											</div>
											<a href="../../assets/imagesfrom/PTPC_therapeutic-exercises_1.jpg" class="popup-img overlay-link" title="image title"><i class="icon-plus-1"></i></a>
										</div>
										<div class="overlay-container overlay-visible">
										...
										<!-- <div class="col-md-6">
											<div class="overlay-container">
												...
												<div class="overlay-to-top">
													<p class="small margin-clear"><em>Therapeutic Exercises<br>Our center is equipped with a full gym.</em></p>
												</div>
											</div>
										</div> -->
										<div class="col-md-6">
								...
								<div class="image-box style-4">
									<div class="row grid-space-0">
										<div class="col-md-6 col-md-push-6">
											<div class="overlay-container">
												<img src="../../assets/imagesfrom/DSC_5158.jpg" alt="">
												<div class="overlay-to-top">
													<p class="small margin-clear"><em>Hand Therapy</em></p>
												</div>
											</div>
										</div>
								...
								<div class="image-box style-4">
									<div class="row grid-space-0">
										<div class="col-md-6">
											<div class="overlay-container">
												<img src="../../assets/imagesfrom/_K4A7132.jpg" alt="">
												<div class="overlay-to-top">
													<p class="small margin-clear"><em>Manual/Neuromuscular Therapy</p>
												</div>
											</div>
										</div>
										<div class="col-md-6">
											<div class="body">
												<div class="pv-30 visible-lg"></div>
												<h3>Manual/Neuromuscular Therapy</h3>
												<div class="separator-2"></div>
												<p class="margin-clear">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam atque ipsam nihialal. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nam laudantium, provident culpa saepe.</p>
												<br>
										...
										<div class="col-md-6 col-md-pull-6">
											<div class="body text-right">
												...
												<ul class="list_in_services">
													...
													<li>Mechanical traction (cervical and pelvic)
													</li>
													<li>Paraffin, cryo- and thermotherapy
													</li>
												</ul>
											</div>
										</div>
